  ...
  <tr><td align='center' style='padding:40px 16px'>
    <table width='520' cellpadding='0' cellspacing='0'
      ...
      <tr><td style='background:#0d6efd;padding:28px 32px;text-align:center'>
        ...
        <h1 style='color:#fff;margin:8px 0 0;font-size:22px'>BookSwap</h1>
      </td></tr>
      <!-- Body -->
      <tr><td style='padding:36px 32px'>
        ...
        <p style='color:#555;line-height:1.6'>
          Thanks for registering on BookSwap — your university textbook marketplace.
      ...
      <tr><td style='background:#f8f9fa;padding:20px 32px;text-align:center;
        ...
        BookSwap · Student Textbook Marketplace<br/>
    ...
    <table width='520' cellpadding='0' cellspacing='0'
      ...
      <tr><td style='background:#f8f9fa;padding:20px 32px;text-align:center;
        ...
        BookSwap · Student Textbook Marketplace
            ...
            // ── Seller notification ────────────────────────────────────────
            var sellerSubject = $"BookSwap — Sale complete: {receipt.TextbookTitle}";
            var sellerHtml = $@"
<!DOCTYPE html>
<html>
<body style='margin:0;padding:0;background:#f4f6f8;font-family:Arial,sans-serif'>
